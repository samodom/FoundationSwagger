...
public extension Date {
    ...
    */
    ...
    /**
        ...
        @param          range Date range in which to check for this date's inclusion.
        @return         Boolean value indicating whether or not this date is within the provided range.
    */
